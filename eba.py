...
def get_yandex_gpt_response(user_message, chat_id):
    try:
        ...
        3. Предложить исправить ситуацию: Подумай, как можно исправить ситуацию
        ...
        2. используй фразу крайне редко «ты не обязан быть идеальным» и её вариации
        3. НИКОГДА не пиши Хэлпер: в начале сообщения
        4. Максимум 1 эмодзи на сообщение
        5. В конце предложения НЕ ставь точку
        6. НЕ пиши про голос, внешность, красоту — ты не видишь и не слышишь
        7. НЕ говори помни, у тебя есть друзья или родственники
        {support_note}
        {history_context}
